...
export const warmupUpdateLimitsCommand: CommandDefinition = {
  ...
  examples: ['bison warmup update-limits --sender-email_ids \'["id1"]\' --daily-warmup_limit 50'],
  ...
  cliMappings: {
    options: [
      ...
      { field: 'daily_warmup_limit', flags: '--daily-warmup-limit <number>', description: 'Daily warmup limit' },
    ],
  },
