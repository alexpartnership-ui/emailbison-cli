...
export const accountsCreateImapSmtpCommand: CommandDefinition = {
  ...
  cliMappings: {
    options: [
      ...
      { field: 'imap_host', flags: '--imap_host <string>', description: 'IMAP server hostname' },
      { field: 'imap_port', flags: '--imap_port <number>', description: 'IMAP server port' },
      { field: 'imap_username', flags: '--imap_username <string>', description: 'IMAP username' },
      { field: 'imap_password', flags: '--imap_password <string>', description: 'IMAP password' },
      { field: 'smtp_host', flags: '--smtp_host <string>', description: 'SMTP server hostname' },
      { field: 'smtp_port', flags: '--smtp_port <number>', description: 'SMTP server port' },
      { field: 'smtp_username', flags: '--smtp_username <string>', description: 'SMTP username' },
      { field: 'smtp_password', flags: '--smtp_password <string>', description: 'SMTP password' },
    ],
  },
